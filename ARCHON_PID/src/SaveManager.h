...
class SaveManager
{
    ...
    static float LeerFloat(const std::map<std::string, std::string>& m, const std::string& clave, float defecto = 0.0f);
    static int   LeerInt  (const std::map<std::string, std::string>& m, const std::string& clave, int defecto = 0);
    static std::string LeerStr(const std::map<std::string, std::string>& m, const std::string& clave, const std::string& defecto = "");
