...
namespace Archon_PID {
    ...
    AI_Agresiva_Tablero::AI_Agresiva_Tablero(bool equipoIA)
    ...
    MovTablero AI_Agresiva_Tablero::decidirMovimiento(PiezaTablero* const tableroReal[9][9])
    {
        CuadriculaSim sim;
    ...
    int AI_Agresiva_Tablero::valorPieza(tipo_pj tipo) const
    {
        switch (tipo) {
        case tipo_pj::MH:           return 500; // Lider: objetivo prioritario
        case tipo_pj::Platero:      return 500;
    ...
    int AI_Agresiva_Tablero::evaluar(const CuadriculaSim& tablero) const
    {
        int puntuacion = 0;
