...
namespace Archon_PID {
    ...
    AI_Defensiva_Tablero::AI_Defensiva_Tablero(bool equipoIA)
        : TableroAI(equipoIA, 3)
    {}
    ...
    MovTablero AI_Defensiva_Tablero::decidirMovimiento(PiezaTablero* const tableroReal[9][9])
    {
        CuadriculaSim sim;
    ...
    int AI_Defensiva_Tablero::valorPieza(tipo_pj tipo) const
    {
        switch (tipo) {
        case tipo_pj::MH:           return 200; // Lider: objetivo prioritario
        case tipo_pj::Platero:      return 200;
        case tipo_pj::Dragon:       return 60;  // Voladores de alto rango
        case tipo_pj::Phoenix:      return 60;
        case tipo_pj::Djinni:       return 40;
        case tipo_pj::Banshee:      return 35;
        case tipo_pj::Valkyrie:     return 30;
        case tipo_pj::ShapeShifter: return 30;
        case tipo_pj::Golem:        return 20;  // Terrestres de apoyo
        case tipo_pj::Troll:        return 20;
        case tipo_pj::Unicorn:      return 15;
        case tipo_pj::Basilisk:     return 15;
        case tipo_pj::Manticore:    return 15;
        case tipo_pj::Archer:       return 10;
        case tipo_pj::Knight:       return 5;  // Peones: prescindibles
        case tipo_pj::Goblin:       return 5;
        default:                    return 5;
        }
    }
    ...
    int AI_Defensiva_Tablero::evaluar(const CuadriculaSim& tablero) const
    {
        int puntuacion = 0;
        ...
        puntuacion += (contIA - contRival) * 30;
